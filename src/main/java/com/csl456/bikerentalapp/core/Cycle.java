...
@NamedQueries({
        ...
        @NamedQuery(name = "Cycle.findById", query = "SELECT C FROM Cycle C " +
                "WHERE C.id = :id"),
        @NamedQuery(name = "Cycle.deleteById", query = "DELETE FROM Cycle C " +
                "WHERE C.id = :id"),
        @NamedQuery(name = "Cycle.findByPersonId", query = "SELECT C FROM " +
                "Cycle C WHERE C.ownerId = :ownerId")
})
@JsonIdentityInfo(generator = ObjectIdGenerators.PropertyGenerator.class,
        property = "id", scope = Cycle.class)
public class Cycle {
