...
public class RolesAllowedFeature implements DynamicFeature {
    ...
    public RolesAllowedFeature(HibernateBundle<BikeRentalAppConfiguration> hibernateBundle, SessionDAO sessionDAO, UserDAO userDAO) {
    ...
    public void configure(ResourceInfo resourceInfo, FeatureContext context) {
        ...
        if (roles != null) {
            RolesFilter rolesFilter = new UnitOfWorkAwareProxyFactory(hibernateBundle)
                    .create(RolesFilter.class,
                            new Class<?>[]{SessionDAO.class, UserDAO.class, UserRole[].class},
