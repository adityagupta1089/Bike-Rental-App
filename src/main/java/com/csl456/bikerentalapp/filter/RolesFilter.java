...
public class RolesFilter implements ContainerRequestFilter {
    ...
    public RolesFilter(SessionDAO sessionDAO, UserDAO userDAO, UserRole[] allowedRoles) {
    ...
    public void filter(ContainerRequestContext requestContext) {
        final String accessToken = requestContext.getHeaderString("Access_Token");
        ...
        if (!allowedRoles.contains(user.getRole())) {
            throw new WebApplicationException("You do not have sufficient allowed Roles.", Response.Status.UNAUTHORIZED);
        }
    }
}
