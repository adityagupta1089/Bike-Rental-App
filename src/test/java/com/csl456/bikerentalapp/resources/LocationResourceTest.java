...
class LocationResourceTest {
    ...
    private static final ResourceExtension RESOURCES =
            ResourceExtension.builder()
                    .addResource(new LocationResource(LOCATION_DAO)).build();
    ...
    void createLocation() {
        ...
        final Response response =
                RESOURCES.target("/location").request(MediaType.APPLICATION_JSON_TYPE)
                        .post(Entity.entity(location,
    ...
    void listLocations() {
        ...
        final List<Location> response =
                RESOURCES.target("/location").request().get(new GenericType<List<Location>>() {
                });
